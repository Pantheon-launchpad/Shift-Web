      ...
      svg: (
        <svg viewBox="0 0 120 40" className="h-8 w-auto">
          <text
            x="0"
            y="30"
            className="text-3xl font-bold fill-gray-400 tracking-wider"
          >
            LOOAO
          </text>
      ...
      svg: (
        <svg viewBox="0 0 140 40" className="h-8 w-auto">
          <circle
            ...
            strokeDasharray="4 2"
          />
          <text x="42" y="28" className="text-2xl font-bold fill-gray-400">
            Logoipsum
          </text>
        </svg>
      ),
    },
    {
      ...
      svg: (
        <svg viewBox="0 0 100 40" className="h-8 w-auto">
          <path
            d="M10 20 Q10 5, 25 5 Q40 5, 40 20 Q40 35, 25 35 Q10 35, 10 20"
            className="fill-none stroke-gray-400"
            strokeWidth="4"
            strokeLinecap="round"
          />
          <path
            d="M35 20 Q35 5, 50 5 Q65 5, 65 20 Q65 35, 50 35 Q35 35, 35 20"
            className="fill-none stroke-gray-400"
            strokeWidth="4"
            strokeLinecap="round"
          />
          <path
            d="M60 20 Q60 5, 75 5 Q90 5, 90 20 Q90 35, 75 35 Q60 35, 60 20"
            className="fill-none stroke-gray-400"
            strokeWidth="4"
            strokeLinecap="round"
          />
    ...
    },
    {
      ...
      svg: (
        <svg viewBox="0 0 140 40" className="h-8 w-auto">
          ...
          <text x="48" y="28" className="text-2xl font-bold fill-gray-400">
            logoipsum
          </text>
          <text x="128" y="15" className="text-lg fill-gray-400">
            ®
          </text>
        </svg>
      ),
  ...
  return (
    <section className="py-16 overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 mb-10">
        <h3 className="text-center text-[var(--text)] text-lg font-semibold">
          Blindly trusted by
        </h3>
      </div>
