  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
      ...
      >
        ...
        {/* Alytics */}
        <div className="bg-white rounded-3xl p-6 border-2 border-purple-800 shadow-xl shadow-purple-500/10">
          <div className="flex items-center gap-2 mb-6">
            <div className="w-8 h-8 bg-purple-800 rounded-lg flex items-center justify-center">
              <span className="text-white font-bold">+</span>
            </div>
            <h3 className="text-xl font-bold text-gray-900">Shift</h3>
          </div>
          <ul className="space-y-4">
            {comparisonData.alytics.map((item, idx) => (
              <li key={idx} className="flex items-center gap-3 text-gray-900 font-medium">
