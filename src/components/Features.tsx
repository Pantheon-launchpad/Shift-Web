...
const features = [
  {
    ...
    description:
      "Not a form. A conversation. Shift asks what you're actually trying to build, then turns the answer into a real roadmap - not a list of vague milestones.",
    type: "interview",
  },
  {
    title: "One task. Today. That\u2019s it.",
    description:
      "No backlog to triage. Every morning, Shift looks at your roadmap and hands you the single highest-impact task, with a focus timer built in.",
    type: "task",
  },
  {
    title: "It remembers, so you don\u2019t have to",
    description:
      "Every night, Shift asks what you actually got done, updates the roadmap, and carries the context forward. It gets sharper about you over time.",
    type: "memory",
  },
  {
    title: "Work in, proof out",
    description:
      "Your messy daily log becomes a clean, shareable update - a streak, a build-in-public card, a progress post. The record writes itself.",
    type: "proof",
  },
];
    ...
    >
      ...
      >
        ...
        <p className="text-muted max-w-lg mx-auto leading-relaxed">
          Four moves, repeated every day, until the goal stops being a goal and
          becomes something you did.
        </p>
      </motion.div>
      ...
      <div className="grid md:grid-cols-2 gap-5 perspective">
        {features.map((feature, idx) => (
          ...
          >
            <div
              className="mb-5 rounded-xl h-40 relative overflow-hidden"
              style={{ background: "var(--ink-1)" }}
            >
              {feature.type === "interview" && (
                <div className="p-4 h-full flex flex-col justify-center gap-2">
                  <div
                    className="self-start max-w-[80%] rounded-2xl rounded-bl-sm px-3 py-2 text-[11.5px]"
                    style={{
                  ...
                  <motion.div
                    ...
                    style={{
                      background: "linear-gradient(135deg, #9653fd, #6629c5)",
                      color: "white",
                    }}
                  ...
                  {[
                    ...
                    >
                      ...
                      <span
                        className="text-[12px]"
                        style={{
                          color: t.active ? "var(--text)" : "var(--text-faint)",
                        }}
                      >
                        {t.label}
                      </span>
              ...
              {feature.type === "memory" && (
                <div className="p-4 h-full flex items-center justify-center relative">
                  <motion.div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, rgba(131,53,253,0.25), rgba(131,53,253,0.05))",
                      border: "1px solid var(--glass-border)",
                    }}
              ...
              {feature.type === "proof" && (
                <div className="p-4 h-full flex items-center gap-3">
                  <div
                    className="flex-1 rounded-lg p-2.5 font-mono text-[10px] leading-relaxed"
                    style={{
                      background: "var(--ink-3)",
                  ...
                  <motion.div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, rgba(242,184,75,0.15), rgba(131,53,253,0.1))",
                      border: "1px solid var(--glass-border)",
                    }}
                  ...
                  >
                    ...
                    <p
                      ...
                      style={{ color: "var(--text-muted)" }}
                    >
                      Auth shipped, 3 bugs fixed, docs written.
                    </p>
                  </motion.div>
                </div>
              )}
            ...
            <div className="mt-auto">
              <h3
                className="text-[17px] font-semibold mb-1.5 font-display"
                style={{ color: "var(--text)" }}
              >
                {feature.title}
              </h3>
