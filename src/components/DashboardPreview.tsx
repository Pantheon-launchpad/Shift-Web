...
export default function DashboardPreview() {
  ...
  return (
    <section
      id="product"
      className="px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto mb-28"
    >
      <motion.div
        ...
        style={{
          ...
          transform: `perspective(1400px) rotateX(${-mouse.y}deg) rotateY(${
            mouse.x
          }deg)`,
      ...
      >
        ...
        >
          ...
          />
          <span className="mx-auto text-[11px] font-mono text-faint">
            shift.app / today
          </span>
        </div>
        ...
        <div className="flex">
          {/* Sidebar */}
          <div
            className="w-56 p-4 hidden sm:block"
          ...
          <div className="flex-1 p-6">
            ...
            >
              <div className="flex items-start justify-between mb-3">
                ...
                <span
                  className="pill px-2.5 py-1 text-[10.5px] font-mono flex items-center gap-1"
                  style={{ color: "var(--gold)" }}
                >
              ...
              <p className="text-[13px] text-muted mb-4 leading-relaxed">
                Roadmap says growth is bottlenecked at activation. This is the
                one thing today that moves "First 10 users" forward the most.
              </p>
                ...
                <div className="space-y-3">
                  {milestones.map((m) => (
                    <div key={m.label} className="flex items-center gap-3">
                      ...
                      {m.current && (
                        <span className="ml-auto text-[10px] font-mono gold-text">
                          now
                        </span>
                      )}
                    </div>
